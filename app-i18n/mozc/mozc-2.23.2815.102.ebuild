...
if [[ "${PV}" == "9999" ]]; then
	...
	SRC_URI="https://github.com/google/${PN}/archive/${MOZC_GIT_REVISION}.tar.gz -> ${P}.tar.gz
		...
		ut? ( https://osdn.net/downloads/users/26/26672/mozcdic-ut-20200924.1.tar.bz2 )"
fi
...
# mozc-ut GPL-2 CC-BY-SA-3 Apache-2 public-domain
LICENSE="BSD BSD-2 ipadic public-domain unicode GPL-2 CC-BY-SA-3 Apache-2 public-domain"
SLOT="0"
KEYWORDS="amd64 ~arm64 ~ppc64 x86"
IUSE="debug emacs fcitx4 +gui +handwriting-tegaki handwriting-tomoe ibus renderer test ut"
...
src_unpack() {
	...
	if use ut; then
		unpack mozcdic-ut-20200924.1.tar.bz2
		cat mozcdic-ut-20200924.1/mozcdic-*-20200924.1.txt >> ${P}/src/data/dictionary_oss/dictionary00.txt || die
	fi
}
